...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_KL] = LAYOUT(
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,    KC_PSCR, KC_SCRL, FB_TOG,
    ...
    [_FL] = LAYOUT(
        ...
        _______, RM_TOGG, RM_VALU, RM_SPDU, RM_HUEU, RM_SATU, _______, _______, DBG_TOG, DBG_KBD, _______, _______, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD,
        _______, RM_NEXT, RM_VALD, RM_SPDD, RM_HUED, RM_SATD, MD_BOOT, _______, DBG_MTRX,DBG_MOU, _______, _______, _______,
        _______,          RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,QK_BOOT, NK_TOGG, _______, _______, _______, _______, _______,                     _______,
        _______, _______, _______,                   EE_CLR,                             _______, _______, KC_F24,  _______,            _______, _______, _______
    ),
    [_PL] = LAYOUT(
